defmodule Noizu.Support.Cms.V2.Database.MockTagTable do
  @moduledoc false
  ...
  defmodule DefaultStrategy do
    @stub %{}
    @table Noizu.Cms.V2.Database.TagTable
    ...
    def write!(_mock_settings, record) do
      Noizu.Support.Cms.V2.Database.MnesiaEmulator.write_bag(@table, record.article, record)
    end
