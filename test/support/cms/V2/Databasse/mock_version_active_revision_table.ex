defmodule Noizu.Support.Cms.V2.Database.MockVersionActiveRevisionTable do
  @moduledoc false
  ...
  defmodule DefaultStrategy do
    @stub %{}
    @table Noizu.Cms.V2.Database.Version.ActiveRevisionTable
    ...
    def write!(_mock_settings, record) do
      Noizu.Support.Cms.V2.Database.MnesiaEmulator.write(@table, record.version, record)
    end
    ...
    def match!(_mock_settings, selector) do
